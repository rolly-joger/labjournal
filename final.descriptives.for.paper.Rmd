...
Understanding the meaning of these numbers ,can be a bit easier if we see the numbers distributed on a histogram:

```{r}
hist(igraph::triad_census(net_graph_w1),
...
Similarly to the previous wave, these numbers can be a bit easier to understand when put into a histogram:

```{r}
hist(igraph::triad_census(net_graph_w2),
